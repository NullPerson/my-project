<template type="html">
  <div class="categories_list" v-if="singleContent !== null">
    <div class="layui-collapse categories-collapse" style="border: none;height: 0;" lay-accordion="">
      <div class="layui-colla-item categroy_title">
        <h2 class="layui-colla-title box-border categroy">
          <span class="categoryName">{{singleContent.ModelName}}</span>
          <span class="categroy_opreation" >
        ...
        <div class="layui-colla-content layui-show" style="padding:0;">
          <div class="layui-nav navigation" style="padding: 0">
            <div class="layui-nav-item app_navigation" v-for="list in singleContent['FunData'] ">
...
<script type="text/ecmascript-6">
  export default {
    ...
    props: ['isEdit', 'items','singleContent'],
    methods: {
      test ($event) {
        console.log('1')
      },
